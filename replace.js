...
content = content.replace(/className="inline-flex items-center justify-center gap-1\.5 bg-indigo-600 hover:bg-indigo-500 text-white px-2 py-1\.5 rounded shadow-lg shadow-indigo-600\/20 transition-all active:scale-95 w-full mx-auto"/g, 'className={`inline-flex items-center justify-center gap-1.5 px-2 py-1.5 rounded shadow-lg transition-all active:scale-95 w-full mx-auto ${dynamicStatus?.label === \\'ATRASADO\\' ? \\'bg-[#E7000B] hover:bg-red-700 text-white shadow-red-600/20 border border-[#ff6c6c]\\' : \\'bg-[#8b9ae6] hover:bg-indigo-500 text-white shadow-indigo-600/20\\'}`}');

// Replace all occurrences of the CITY cell
