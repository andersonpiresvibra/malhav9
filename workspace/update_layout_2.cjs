const fs = require('fs');
let code = fs.readFileSync('/app/applet/src/components/ReportsView.tsx', 'utf8');
...
fs.writeFileSync('/app/applet/src/components/ReportsView.tsx', before + newContent + after);
console.log("SUCCESS!");
